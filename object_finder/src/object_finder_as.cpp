...
bool ObjectFinder::find_toy_block(float surface_height, geometry_msgs::PoseStamped &object_pose) {
    ...
    found_object = pclUtils_.find_plane_fit(0.5, 1, -0.3, 0.3, surface_height + .0125, surface_height + 0.05, 0.001,
...
int main(int argc, char** argv) {
    ...
    while (tferr) {
        ...
        try {
            ...
            tfListener.lookupTransform("base", "camera_depth_optical_frame", ros::Time(0), stf_kinect_wrt_base);
