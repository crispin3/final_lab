...
const double default_accel_max = 0.1; //1m/sec^2
const double default_alpha_max = 0.1; //1 rad/sec^2
const double default_speed_max = 0.2; //1 m/sec
const double default_omega_max = 0.3; //1 rad/sec
...
public:
    ...
    void build_braking_traj(geometry_msgs::PoseStamped start_pose,
            std::vector<nav_msgs::Odometry> &vec_of_states);
    void build_backup_traj(geometry_msgs::PoseStamped start_pose, geometry_msgs::PoseStamped end_pose, std::vector<nav_msgs::Odometry> &vec_of_states);
